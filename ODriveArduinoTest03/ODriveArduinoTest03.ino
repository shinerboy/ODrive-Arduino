...
//      odrive.run_state(motornum, requested_state, true);
    ...
    if (c == 'u') {
      ...
      String torque = Serial.readString();
      String torque2 = torque;
      Serial.println(torque);

      while(torque == torque2)
      {
        torque = Serial.readString();
        //sp = sp.toInt();
        Serial.println(torque);
      }
      ...
      while (yn != 'y')
        {
          ...
          {
            torque = torque_init;
            Serial.println("Torque not changed");
            break;
            }
          if (yn == 'y')
          {
            Serial.println("Succesfully set torque!");
            torque_init = torque.toInt();
            }
          delay(5);
        }
     }
    ...
    if (c == 'p') {
      ...
      { 
        ...
        test = Serial.read();
        float pos_m0 = 5000.f; //20000.0f = 360 degrees. 
    ...
    if (c == 'o') {
      ...
      { 
        ...
        test = Serial.read();
        float pos_m0 = 0.f; //20000.0f = 360 degrees. 
        //float pos_m1 = 20000.0f * sin(ph);
        odrive.SetPosition(0, pos_m0);
        //odrive.SetPosition(1, pos_m1);
        delay(5);
